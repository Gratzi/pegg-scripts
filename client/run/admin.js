...
(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.onCardLoaded = function(data) {
      var choice, choiceId, i, ref, results1;
      this.resetForm('card');
      ...
      results1 = [];
      for (choiceId in ref) {
        if (!hasProp.call(ref, choiceId)) continue;
        choice = ref[choiceId];
  ...
  ServerActions = (function() {
    ...
    ServerActions.prototype._cleanupCard = function(card) {
      ...
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        choice = ref[i];
        if (_.isEmpty(choice.objectId) && _.isEmpty(choice.text) && _.isEmpty(choice.image.meta.url)) {
